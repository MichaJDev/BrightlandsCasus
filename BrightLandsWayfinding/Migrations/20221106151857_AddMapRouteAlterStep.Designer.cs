...
namespace BrightLandsWayfinding.Migrations
{
    ...
    [Migration("20221106151857_AddMapRouteAlterStep")]
    partial class AddMapRouteAlterStep
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BrightLandsWayfinding.Models.MapRoutes.MapRoute", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BrightLandsWayfinding.Models.Steps.Step", b =>
                {
                    ...
                    b.Property<int>("MapRouteID")
                        .HasColumnType("int");

                    b.HasKey("ID");

                    b.HasIndex("MapRouteID");
            ...
            modelBuilder.Entity("BrightLandsWayfinding.Models.MapRoutes.MapRoute", b =>
                {
                    b.HasOne("BrightLandsWayfinding.Models.Rooms.Room", "EndLocation")
                        .WithMany()
                        .HasForeignKey("EndLocationID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BrightLandsWayfinding.Models.Rooms.Room", "StartLocation")
                        .WithMany()
            ...
            modelBuilder.Entity("BrightLandsWayfinding.Models.Steps.Step", b =>
                {
                    b.HasOne("BrightLandsWayfinding.Models.MapRoutes.MapRoute", "MapRoute")
                        .WithMany("Steps")
                        .HasForeignKey("MapRouteID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MapRoute");
                });
